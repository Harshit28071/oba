...
function loadcity(){
    $.ajax({
        url : "/new/oba/admin/apis/select/get_city.php",
        type : "GET",
        dataType : "json",
...
function loadState(){
    $.ajax({
        url : "/new/oba/admin/apis/select/get_states.php",
        type : "GET",
        dataType : "json",
        success : function(data){
          displayState(data);
...
function loadDistributor(){
    $.ajax({
        url : "/new/oba/common/apis/select/get_distributor.php",
        type : "GET",
        dataType : "json",
        success : function(data){
...
function loadSingleCustomer(){
    ...
    $.ajax({
        url: "/new/oba/common/apis/select/get_single_customer.php",
        type: "POST",
...
$("#edit-customer-form").on("submit",function(e){
    ...
    $.ajax({
            type: 'POST',
            url: '/new/oba/salesman/apis/update/edit_customer_details.php',
