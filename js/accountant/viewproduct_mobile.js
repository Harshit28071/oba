...
function loadProducts(){
  ...
  $.ajax({
    url : "/new/oba/apis/select/accountant/get_all_product.php",
    type : "GET",
    dataType : "json",
    success : function(data){
      products = data;
...
$('#remove-product-form').on('submit', function (e) {
 ...
 function viewproduct(id){
  ...
  window.location.href = '/new/oba/pages/accountant/mobile/view_product_details.php?id='+ id +'';

 }
 function editproduct(id){
  
  window.location.href = '/new/oba/pages/accountant/mobile/edit_product.php?id='+ id +'';
