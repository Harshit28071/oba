...
session_start();
 ...
 if(!isset($_SESSION['s_username']) && $_SESSION["s_suffix"] != "Admin"){
          ...
          <form id="edit-suffix-from">
            ...
            <div class="modal-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="editname" id="edit-suffix" placeholder="Enter Suffix" autocomplete="off" required>
            ...
            <button type="submit" class="btn btn-warning" id="edit-suffix-save">Save Changes</button>
        ...
        <div class="modal-dialog">
          ...
          <form id="add-suffix-form">
            ...
            <div class="modal-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" name="Add-name" id="Add-suffix" placeholder="Enter Suffix"  autocomplete="off" required>
                    <span id="validation" class="text-danger"></span>
                  </div>
            </div>
            <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                  <button type="submit" class="btn btn-primary" id="add-suffix-sub">Add</button>
          ...
          <div id="loader-remove-suffix" style="display:none;" class="overlay">
           ...
           <form id="add-remove-form">
            ...
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
              <button type="submit" class="btn btn-danger" id="remove-suffix-sub">Remove</button>
...
function loadTable(){
    $("#load-table").html("");
    $.ajax({
        url : "../../admin/apis/select/get_suffix.php",
        type : "GET",
        dataType : "json",
          ...
          var html ='';
            ...
            $.each(data,function(key,value){
              html = html +("<tr>"+
                                   ...
                                   "<td>" + value.suffix +"</td>"+ 
                                  "<td><a href='#' class='edit-suffix' data-eid='"+ value.id +"'><i class='fas fa-edit'></i></a> &nbsp; &nbsp;<a href='#' class='remove-suffix'  data-rid='"+ value.id +"'><i class='fa fa-trash' aria-hidden='true' style='color:red;'></i></a></td>"+
                                  "</tr>");
            });
...
$(document).on("click",".edit-suffix",function(){
   ...
   // console.log(myJson);
    $.ajax({
       url :"../../admin/apis/select/fetch_single_suffix.php",
       type : "POST",
       data : myJson,
       dataType : "json",
       success : function(data){
    ...
    $("#edit-suffix-from").on("submit",function(e){
      toastr.options = {
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/update/update_suffix.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
    ...
    $("#add-suffix-form").on("submit",function(e){
      ...
      $("#loader-suffix").show();
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/add/add_suffix.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
...
//Add Suffix Close
//Delete Suffix 
$(document).on("click",".remove-suffix",function(){
  $('#modal-remove-suffix').modal('show');
    ...
    $("#add-remove-form").on("submit",function(e){
      ...
      $("#loader-remove-suffix").show();
        ...
        //console.log(jsonobj);
        $.ajax({
            url : "../../admin/apis/delete/delete_suffix.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
