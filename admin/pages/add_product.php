...
$options_unit = loadUnits();
$options_firm = loadFirms();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="wrapper">
  ...
  <?php require_once($_SERVER['DOCUMENT_ROOT']."/new/oba/common/pages/add_product_content.php"); ?>
...
<script src="/new/oba/common/js/add_product.js"></script>
</body>
</html>
