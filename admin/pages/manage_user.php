...
function loadTableUser(){
    ...
    $.ajax({
        url : "../../admin/apis/select/get_user.php",
        type : "GET",
        dataType : "json",
...
$(document).on("click",".edit-user",function(){
   ...
   // console.log(myJson);
    $.ajax({
       url :"../../admin/apis/select/fetch_single_user.php",
       type : "POST",
       data : myJson,
       dataType : "json",
       success : function(data){
    ...
    $("#edit-user-form").on("submit",function(e){
      ...
      $("#loader-edit-user").show();
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/update/update_user.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
    ...
    $("#add-user-form").on("submit",function(e){
      ...
      toastr.options = {
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/add/add_user.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
...
//     //delete role
    $("#user-remove-form").on("submit",function(e){
      ...
      toastr.options = {
        ...
        //console.log(jsonobj);
        $.ajax({
            url : "../../admin/apis/delete/delete_user.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
