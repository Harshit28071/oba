...
function loadTableunit(){
    ...
    $.ajax({
        url : "../../admin/apis/select/get_units.php",
        type : "GET",
        dataType : "json",
...
$(document).on("click",".edit-unit",function(){
    ...
    console.log(myJson);
    $.ajax({
       url :"../../admin/apis/select/fetch_single_unit.php",
       type : "POST",
       data : myJson,
       dataType : "json",
       success : function(data){
    ...
    $("#edit-unit-form").on("submit",function(e){
      ...
      toastr.options = {
       ...
       console.log("Fill The Input");
        ...
        $.ajax({
            url : "../../admin/apis/update/update_unit.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
    ...
    $("#add-unit-form").on("submit",function(e){
      ...
      //  e.preventDefault();
       ...
       console.log("Fill The Input");
        ...
        $.ajax({
            url : "../../admin/apis/add/add_unit.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
  ...
  $('#modal-remove-unit').modal('show');
    ...
    $("#add-remove-form").on("submit",function(e){
      ...
      toastr.options = {
        ...
        //console.log(jsonobj);
        $.ajax({
            url : "../../admin/apis/delete/delete_unit.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
