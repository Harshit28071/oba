...
function loadTableState(){
    ...
    $.ajax({
        url : "../../admin/apis/select/get_states.php",
        type : "GET",
        dataType : "json",
...
$(document).on("click",".edit-state",function(){
   ...
   // console.log(myJson);
    $.ajax({
       url :"../../admin/apis/select/fetch_single_state.php",
       type : "POST",
       data : myJson,
       dataType : "json",
       success : function(data){
    ...
    $("#edit-state-form").on("submit",function(e){
      ...
      $("#loader-edit-state").show();
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/update/update_state.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
    ...
    $("#addstateform").on("submit",function(e){
      ...
      $("#loader-add-state").show();
       ...
       if(jsonobj == false ){
        ...
        $.ajax({
            url : "../../admin/apis/add/add_state.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
...
//     //delete role
    $("#remove-state-sub").on("click",function(e){
      ...
      $("#loader-remove-state").show();
        ...
        //console.log(jsonobj);
        $.ajax({
            url : "../../admin/apis/delete/delete_state.php",
            type : "POST",
            data : jsonobj,
            dataType : "json", 
            success : function(data){
