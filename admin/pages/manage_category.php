    ...
    $(document).on("click","#add-new-category",function(){
        ...
        $('#add-category-form').on('submit',function(e){
          ...
          toastr.options = {
            ...
            $.ajax({
            type: 'POST',
            url: '../../admin/apis/add/add_category.php',
...
function loadTableCategory(){
    ...
    $.ajax({
        url : "../../admin/apis/select/get_category.php",
        type : "GET",
        dataType : "json",
        success : function(data){
          var html ='';
            ...
            $.each(data,function(key,value){
              ...
              html = html +("<tr>"+
                                   "<td>" + value.name +"</td>"+
                                   "<td><img src='http://localhost/oba/oba/oba/apis/admin/pages/uploads/"+imgurl+"' width='30px' height='30px'></td>"+
...
$(document).on("click",".edit-category",function(){
   ...
   // console.log(myJson);
    $.ajax({
       url :"../../admin/apis/select/fetch_single_category.php",
       type : "POST",
       data : myJson,
       dataType : "json",
       success : function(data){
...
$('#edit-category-form').on('submit',function(e){
    ...
    toastr.options = {
            ...
            $.ajax({
            type: 'POST',
            url: '../../admin/apis/update/update_category.php',
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
            cache: false,
...
$('#remove-category-form').on('submit',function(e){
            ...
            $.ajax({
            type: 'POST',
            url: '../../admin/apis/delete/delete_category.php',
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
            cache: false,
