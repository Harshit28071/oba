    ...
    if (data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            html = html + '<tr>' +
                ...
                '<td >' + getInput("rate", data[i].itemPrice, data[i].id, i) + '<table class="table-sm" style="margin-top:5px"><tr><td><strong>Min </strong></td><td>&#x20B9;'+data[i].minPrice +'</td><td><strong>Max </strong></td><td>&#x20B9;'+data[i].maxPrice +'</td><td><strong>Last </strong></td><td>&#x20B9;'+data[i].customerPrice +'</td></tr></table></td>' +
